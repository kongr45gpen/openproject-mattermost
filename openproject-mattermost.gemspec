# -*- encoding: utf-8 -*-
# stub: openproject-mattermost 0.7.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://github.com/zaproo/pm2mattermost".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "3.0.6".freeze
  s.summary = "OpenProject Mattermost".freeze
